...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '@user\n ¡𝙀𝙡 𝙈𝙚𝙟𝙤𝙧 𝘽𝙤𝙩 𝘿𝙚 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝙏𝙚 𝘿𝙖 𝙇𝙖 𝘽𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙖 𝙖𝙡 𝙂𝙧𝙪𝙥𝙤 😈!';
  conn.bye = '¡𝙉𝙤 𝙛𝙪𝙞𝙨𝙩𝙚𝙨 𝙙𝙞𝙜𝙣𝙭 𝙙𝙚 𝙥𝙚𝙧𝙩𝙚𝙣𝙚𝙘𝙚𝙧 𝙖 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤, 𝙎𝙖𝙥𝙖𝙨𝙤𝙤 🤣!!\n@user';
  conn.spromote = '*[ 🐼 ] @user 𝘊𝘳𝘢𝘻𝘺 𝘉𝘰𝘵 𝘛𝘦 𝘗𝘳𝘰𝘮𝘰𝘷𝘪𝘰 𝘢 𝘈𝘥𝘮𝘪𝘯 𝘋𝘦𝘭 𝘔𝘦𝘫𝘰𝘳 𝘨𝘳𝘶𝘱𝘰!!*';
  conn.sdemote = '*[ 🐼 ] @user 𝘊𝘳𝘢𝘻𝘺 𝘉𝘰𝘵 𝘛𝘦 𝘋𝘦𝘨𝘳𝘢𝘥𝘹 𝘢 𝘐𝘯𝘵𝘦𝘨𝘳𝘢𝘯𝘵𝘦 𝘋𝘦𝘭 𝘔𝘦𝘫𝘰𝘳 𝘨𝘳𝘶𝘱𝘰!!*';
  conn.sDesc = '*[ 🐼 ] 𝘓𝘢 𝘥𝘦𝘴𝘤𝘳𝘪𝘱𝘤𝘪ó𝘯 𝘥𝘦𝘭 𝘨𝘳𝘶𝘱𝘰 𝘩𝘢 𝘴𝘪𝘥𝘰 𝘮𝘰𝘥𝘪𝘧𝘪𝘤𝘢𝘥𝘰.*';
...
setInterval(async () => {
  ...
  const bio = `𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 𝙚𝙡 𝙈𝙚𝙟𝙤𝙧 𝘽𝙤𝙩 🐼`;
