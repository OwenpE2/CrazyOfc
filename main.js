...
global.reloadHandler = async function(restatConn) {
  ...
  conn.bye = '¡𝙎𝙖𝙛𝙖 𝙎𝙖𝙛𝙖 𝙨𝙖𝙥𝙖𝙨𝙤 𝘾𝙤𝙡𝙤𝙧 𝙋𝙪𝙚𝙧𝙩𝙖 🤣!\n@user';
  conn.spromote = '*[ 🐼 ] @user 𝘍𝘶𝘪𝘴𝘵𝘦𝘴 𝘗𝘳𝘰𝘮𝘰𝘷𝘪𝘥𝘰 𝘢 𝘈𝘥𝘮𝘪𝘯 𝘢𝘭 𝘔𝘦𝘫𝘰𝘳 𝘎𝘳𝘶𝘱𝘰!!*';
  conn.sdemote = '*[ 🐼 ] @user 𝘍𝘶𝘪𝘴𝘵𝘦𝘴 𝘥𝘦𝘨𝘳𝘢𝘥𝘢𝘥𝘰 𝘢 𝘐𝘯𝘵𝘦𝘨𝘳𝘢𝘯𝘵𝘦 𝘥𝘦𝘭 𝘔𝘦𝘫𝘰𝘳 𝘎𝘳𝘶𝘱𝘰!!*';
