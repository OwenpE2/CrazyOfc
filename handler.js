    ...
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        // await this.sendContact(nk.from, data.map(([id, name]) => [id, name]), false, { quoted: callmsg })
	        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑;;;\nFN:𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑\nORG:𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑\nTITLE:\nitem1.TEL;waid=51942286712:+51 942 286 712\nitem1.X-ABLabel:𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑙 𝑝𝑟𝑜𝑝𝑖𝑒𝑡𝑎𝑟𝑖𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
    owner: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑙 𝑝𝑟𝑜𝑝𝑖𝑒𝑡𝑎𝑟𝑖𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
    mods: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑝𝑜𝑟 𝑚𝑜𝑑𝑒𝑟𝑎𝑑𝑜𝑟𝑒𝑠 𝑦 𝑒𝑙 𝑝𝑟𝑜𝑝𝑖𝑒𝑡𝑎𝑟𝑖𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
    premium: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑝𝑜𝑟 𝑢𝑠𝑢𝑟𝑖𝑜𝑠 𝑝𝑟𝑒𝑚𝑖𝑢𝑚 𝑦 𝑒𝑙 𝑝𝑟𝑜𝑝𝑖𝑒𝑡𝑎𝑟𝑖𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
    group: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑒𝑛 𝑔𝑟𝑢𝑝𝑜𝑠.*',
    private: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑑𝑜 𝑒𝑛 𝑒𝑙 𝑐ℎ𝑎𝑡 𝑝𝑟𝑖𝑣𝑎𝑑𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
    admin: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑠𝑜𝑙𝑜 𝑝𝑢𝑒𝑑𝑒 𝑠𝑒𝑟 𝑢𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑎𝑑𝑚𝑖𝑛𝑖𝑠𝑡𝑟𝑎𝑑𝑜𝑟𝑒𝑠 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜.*',
    botAdmin: '*[ 😈 ] 𝑃𝑎𝑟𝑎 𝑢𝑡𝑖𝑙𝑖𝑧𝑎𝑟 𝑒𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑒𝑠 𝑛𝑒𝑐𝑒𝑠𝑎𝑟𝑖𝑜 𝑞𝑢𝑒 𝑦𝑜 𝑠𝑒𝑎 𝑎𝑑𝑚𝑖𝑛𝑖𝑠𝑡𝑟𝑎𝑑𝑜𝑟 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜.*',
    unreg: '*[ 😈 ] 𝐴𝑙𝑡𝑜 𝑛𝑜 𝑒𝑠𝑡𝑎𝑠 𝑟𝑒𝑔𝑖𝑠𝑡𝑟𝑎𝑑𝑜.*\n\n*[ 💡 ] 𝑈𝑡𝑖𝑙𝑖𝑧𝑎 𝑒𝑙 𝑐𝑜𝑚𝑎𝑛𝑑𝑜:* _#𝑣𝑒𝑟𝑖𝑓𝑖𝑐𝑎𝑟 𝑛𝑜𝑚𝑏𝑟𝑒.𝑒𝑑𝑎𝑑_ *𝑝𝑎𝑟𝑎 𝑟𝑒𝑔𝑖𝑠𝑡𝑟𝑎𝑟𝑡𝑒.*',
    restrict: '*[ 😈 ] 𝐸𝑠𝑡𝑒 𝑐𝑜𝑚𝑎𝑛𝑑𝑜 𝑓𝑢𝑒 𝑟𝑒𝑠𝑡𝑟𝑖𝑛𝑔𝑖𝑑𝑜 𝑝𝑜𝑟 𝑒𝑙 𝑝𝑟𝑜𝑝𝑖𝑒𝑡𝑎𝑟𝑖𝑜 𝑑𝑒𝑙 𝑏𝑜𝑡.*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '𝘾𝙧𝙖𝙯𝙮 𝘽𝙤𝙩 🐼 ', body: '@oween._.001', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/oween._.001/'}}}}, aa);
